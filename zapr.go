...
// which adds support for logr.ObjectMarshaler.
func zapAny(key string, value interface{}) zapcore.Field {
	switch val := value.(type) {
	case zapcore.ObjectMarshaler:
		return zap.Object(key, val)
	case logr.ObjectMarshaler:
		return zap.Object(key, wrapObject(val))
...
func wrapObject(value logr.ObjectMarshaler) zapcore.ObjectMarshaler {
	return objectMarshaler{value: value}
}

type objectMarshaler struct {
	value logr.ObjectMarshaler
}

func (o objectMarshaler) MarshalLogObject(encoder zapcore.ObjectEncoder) error {
	return o.value.MarshalLogObject(wrapEncoder(encoder))
}

var _ zapcore.ObjectMarshaler = objectMarshaler{}

func wrapEncoder(encoder zapcore.ObjectEncoder) logr.ObjectEncoder {
	return objectEncoder{ObjectEncoder: encoder}
}
...
var _ logr.ObjectEncoder = objectEncoder{}
